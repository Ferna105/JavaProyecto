...
<html>
    ...
    <body>
        ...
        <div style="border: 1px solid black; background: #004466">
            <nav style="background: #000"><h1 align="center">Todos los pedidos</h1></nav>
            ...
            <% 
                ...
                pedidos= ped.listadoPedidosPorEstado("%");
            ...
            <tr>
                ...
                <td><label>Fecha: </label><%=pedidos.get(i).getFecha()%>
                    <input type="hidden" name="fecha" value="<%=pedidos.get(i).getFecha()%>">
                <br><label>Hora: </label><%=pedidos.get(i).getHora()%>
                    <input type="hidden" name="hora" value="<%=pedidos.get(i).getHora()%>">
                <br><label>Estado: </label><%=pedidos.get(i).getEstado()%>
                <br><label>Dirección: </label><%=pedidos.get(i).getCalleDireccion()%>
                <%=pedidos.get(i).getNumeroDireccion()%>
                <%if (pedidos.get(i).getFechaConfirmacion()!=null){%>
                        <br>Fecha de confirmación: <%=pedidos.get(i).getFechaConfirmacion()%>
                        <br>Hora de confirmación: <%=pedidos.get(i).getHoraConfirmacion()%>
