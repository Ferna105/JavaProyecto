<%-- 
    Document   : listadoEnsaladas
    Created on : 28-dic-2016, 0:20:38
    Author     : Ferna
--%>
...
<html>
    ...
    <body>
        ...
        <table border="1">
            <tr>
                <nav style="background: #000"><h1 align="center">Listado de Ensaladas</h1></nav>
            </tr>
            <% ArrayList<Producto> prod = new ArrayList<Producto>();
            ProductoConsultasSQL pc = new ProductoConsultasSQL();
            prod = pc.listadoProductos("Ensalada"); %>
