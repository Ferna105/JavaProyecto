...
<html>
    ...
    <body>
        ...
        <div style="border: 1px solid black; background: #004466">
            <nav style="background: #000"><h1 align="center">Pedidos confirmados</h1></nav>
            ...
            <% 
                ...
                pedidos= ped.listadoPedidosPorEstado("Confirmado");
            ...
            <tr>
                ...
                <br>Fecha Confirmación: <%=pedidos.get(i).getFechaConfirmacion()%>
                <br>Hora Confirmación: <%=pedidos.get(i).getHoraConfirmacion()%>
